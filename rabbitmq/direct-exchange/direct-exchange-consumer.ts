...
async function sendOrderEvents() {
    ...
    const exchange = "xpto.direct"; // criamos uma exchange do tipo direct
    await channel.assertExchange(exchange, "direct"); // se nao existir, cria

    // Note: Nao estamos criando as filas aqui, pois elas ja estao criadas
